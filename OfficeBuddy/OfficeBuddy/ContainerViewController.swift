...
class ContainerViewController: UIViewController {
    ...
    init(slideMenu: UIViewController, center: UINavigationController) {
        menuViewController = slideMenu
    ...
    override func viewDidLoad() {
        ...
        (menuViewController as! SlideMenuViewController).headerHeight = centerViewController.navigationBar.frame.size.height
